function insertProfMiniCV(profName){
   ...
   /* ------------------ PROFESSORES COM LETRA C ------------------ */   
    ...
    if(profName == "Catarina Florio"){
		var profMiniCV = "Atualmente é Gerente de Produto da WPP Media Services, aprimorando o conhecimento em todos os níveis de mídia na WMS, democratizando o acesso às informações técnicas e alinhando metodologias de rápido crescimento. O planejamento de mídia sempre foi sua paixão. Já trabalhei na liderança de produtos com grandes clientes de CPG, como Unilever na categoria de cabelos e Beiersdorf. Também teve experiência com campanhas de branding e performance dos segmentos Automotivo, Financeiro, Eletrônico e Turismo."
	}

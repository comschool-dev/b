...
function insertProfMiniCV(profName){
    ...
    if(profName == "Alexandre Bissoli"){
		...
		profMiniCV += "<br><a href='/Alexandre-Bissoli' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Alexandre Secco"){
		...
		profMiniCV += "<br><a href='/Alexandre-Secco' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Ana Paula Passarelli"){
		...
		profMiniCV += "<br><a href='/Ana-Passarelli' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Anderson Palma"){
		...
		profMiniCV += "<br><a href='/Anderson-Palma' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "André Bonanomi"){
		...
		profMiniCV += "<br><a href='/Andre-Bonanomi' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "André Ferracini"){
		...
		profMiniCV += "<br><a href='/Andre-Ferracini' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "André Massa"){
		...
		profMiniCV += "<br><a href='/Andre-Massa' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "André Santos"){
		...
		profMiniCV += "<br><a href='/Andre-Santos' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "André Tavares"){
		...
		profMiniCV += "<br><a href='/Andre-Tavares' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Andrei Scheiner"){
		...
		profMiniCV += "<br><a href='/Andrei-Scheiner' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Angelo Vicente"){
		...
		profMiniCV += "<br><a href='/Angelo-Vicente' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Arthur Attili"){
		...
		profMiniCV += "<br><a href='/Arthur-Attili' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Augusto Rocha"){
		var profMiniCV = "Sócio da Pmweb Responsys, uma das maiores agencias especializadas em turismo On Line, evangelista da inovação através do marketing digital, foi um dos percursores da distribuição direta no turismo e novos conceitos de relacionamento entre empresas e clientes através de canais digitais. É freqüentador das delegações da américa latina nos principais eventos de ecommerce, varejo e marketing digital no mercado norte americano. É articulista da revista Ecommerce Brasil, e palestrante com participações em diversos eventos no Brasil, no Chile e França."
		profMiniCV += "<br><a href='/Augusto-Rocha' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Breno Spadotto"){
		...
		profMiniCV += "<br><a href='/Breno-Spadotto' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Bruno Goulart"){
		...
		profMiniCV += "<br><a href='/Bruno-Goulart' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Bruno Miracco"){
		var profMiniCV = "Bruno é formado em Marketing pela FMU-SP e cursa MBA em Finanças pela Saint Paul Escola de Negócios. Trabalhou três anos no departamento de Trade Marketing da Coca-Cola e, há 5 anos, atua em posições de Business Intelligence, em agências de publicidade de grande relevância, atendendo clientes como Ambev, Nestlé, Unilever, Itaú, Samsung e McDonald's. Essas experiências variadas proporcionaram sólido conhecimento em torno da análise de dados focada em Marketing Digital, incluindo os requisitos para que isso seja possível."
		profMiniCV += "<br><a href='/Bruno-Miracco' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Bruno Perez"){
		...
		profMiniCV += "<br><a href='/Bruno-Perez' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Bruno Rodrigues"){
		...
		profMiniCV += "<br><a href='/Bruno-Rodrigues' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Caio Bertolazzo"){
		...
		profMiniCV += "<br><a href='/Caio-Bertolazzo' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Caroline Rembowski"){
		...
		profMiniCV += "<br><a href='/Caroline-Rembowski' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Cesário Carvalho"){
		...
		profMiniCV += "<br><a href='/Cesario-Carvalho' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Christopher Neiverth"){
		...
		profMiniCV += "<br><a href='/Christopher-Neiverth' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Cleber Fonseca"){
		...
		profMiniCV += "<br><a href='/Cleber-Fonseca' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Cristiano Creczyenski"){
		...
		profMiniCV += "<br><a href='/Cristiano-Creczyenski' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Cristiano Santos"){
		...
		profMiniCV += "<br><a href='/Cristiano-Santos' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Daniel Bento"){
		...
		profMiniCV += "<br><a href='/Daniel-Bento' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Daniel Nepomuceno"){
		var profMiniCV = "Responsável pela criação do E-Commerce de grandes marcas em projetos de B2B e B2C como Vivo, TIM, Positivo, Renner, Meu Amigo Pet, Audi e Jones Lang La Salle. Mais de 15 anos de experiência em e-commerce. No Meu Amigo Pet foi responsável pelo start up de toda operação e todo planejamento estratégico.Participou de vários processos de M&A auxiliando empresas a construir business plans e captar investimentos. Experiência em Novos Negócios, business case, automação, plano estratégico, gerenciamento de projetos (PMI), plano de negócios e gestão de produtos. Report direto para Investidores / Fundo de Investimento e Conselho Administrativo.O Meu Amigo Pet é referência no setor, com mais de 100 funcionários e 2 milhões de fãs no Facebook. Em 2011 foi case pioneiro de "pure player" que foi para o mundo físico, estruturando as franquias da marca e tornando-a a 1º e maior rede de franquias do segmento Pet no país. Em 2014, a rede abrangia 15 lojas físicas, algumas delas apresentaram breakeven no primeiro mês de operação.Firmou parcerias de sucesso, operando a categoria em grandes varejistas tais como Americanas, Extra, Mercado Livre, Shop Fácil, Saraiva, Submarino e Wal Mart. Parcerias com Nestle, Royal Canin, etc. Personalidades estratégicas (Alexandre Rossi - Dr. Pet, ONGs, Karina Bacchi e Romero Britto). Participações em TV (Band, Globo e Gugu) e campanhas com personalidades.Participou como palestrante em eventos nacionais e internacionais, tais como Shop.Org, Internet Retailer, Global Pet Expo e CIPS China."
		profMiniCV += "<br><a href='/Daniel-Nepomuceno' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Dayane Mofacto"){
		...
		profMiniCV += "<br><a href='/Dayane-Mofacto' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Denis Andrade"){
		...
		profMiniCV += "<br><a href='/Denis-Andrade' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Denis Casita"){
		var profMiniCV = "Profissional graduado em Administração para Internet pela FIAP. Possui especializações na área de Marketing Online, Análise e Planejamento Financeiro, Técnicas de Feedback e Liderança pela FIA e Gestão Empresarial pela FGV.Especialista em Search Marketing, possui certificado Google Adwords Professional e Seo Training Course pela Bruce Clay INC e SEO BrightEdge Certified Professional. Mais de 12 anos de experiência dos quais teve passagem por grandes empresas de varejo online, como Submarino, Americanas e Kalunga.com. Vencedor do prêmio Digitalks na categoria melhor profissional de Links Patrocinados do Brasil - 2015Finalista do prêmio Digitalks na categoria melhor profissional de Links Patrocinados do Brasil - 2014Analítico e orientado à resultados esta atualmente desenvolvendo sua própria startup, a Performa Web, agência especializada em marketing online."
		profMiniCV += "<br><a href='/Denis-Casita' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Denis Smetana"){
		...
		profMiniCV += "<br><a href='/Denis-Smetana' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Dimas Mombach de Oliveira"){
		...
		profMiniCV += "<br><a href='/Dimas-Oliveira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Douglas Martineli"){
		...
		profMiniCV += "<br><a href='/Douglas-Martineli' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Edilaine Godoi"){
		...
		profMiniCV += "<br><a href='/Edilaine-Godoi' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Edmilson Maleski"){
		var profMiniCV = "Formado em Administração de empresas e com mais de 15 anos liderando a área comercial de multinacionais e grandes/médias empresas de varejo, é atualmente o Head de e-commerce da empresa Dufrio Refrigeração. Possui amplo conhecimento do processo produtivo do varejo, formação de times de alta performance, gestão por processos desde o desenho, definição de ferramentas e implementação e metodologias de gestão com foco no resultado."
		profMiniCV += "<br><a href='/Edmilson-Maleski' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Eduardo Koch"){
		...
		profMiniCV += "<br><a href='/Eduardo-Koch' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Eduardo Oliveira"){
		var profMiniCV = "Eduardo Oliveira é especialista em estratégias e ferramentas de comércio eletrônico atuando no mercado de internet e tecnologia da informação há mais de 15 anos. Fundador e CEO da empresa F1 - Soluções Inteligência em Comércio Eletrônico, especializada no desenvolvimento de plataforma de e-commerce, responsável pela operação de mais de 600 lojas virtuais, colaborando com as estratégias de vendas online de empresas como FGV, JBL, Cultura Inglesa, Multisom, Camisaria Colombo dentre tantas outras."
		profMiniCV += "<br><a href='/Eduardo-Oliveira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Eliziane Lettieri Vezzosi"){
		...
		profMiniCV += "<br><a href='/Eliziane-Vezzosi' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Eric Gallardo"){
		...
		profMiniCV += "<br><a href='/Eric-Gallardo' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Erick Massa Sprengel"){
		...
		profMiniCV += "<br><a href='/Erick-Sprengel' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fabiana Alvarez"){
		...
		profMiniCV += "<br><a href='/Fabiana-Alvarez' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fabiana Louzane"){
		...
		profMiniCV += "<br><a href='/Fabiana-Louzane' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fabio Fialho"){
		...
		profMiniCV += "<br><a href='/Fabio-Fialho' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fabio Marão"){
		var profMiniCV = "Gerente de Marketing Interativo e E-commerce da Azul Linhas Aéreas. Responsável por toda a comunicação digital da Azul, incluindo o canal B2C, redes sociais e campanhas on line. Na empresa desde o start up, ajudou a criar a marca no ambiente digital com várias ações inovadoras, buscando sempre trazer sempre a melhor experiência para o cliente. Trabalhando com marketing digital desde 1996, já prestou seviços para várias agências de propaganda, desenvolvendo projetos para os mercados de transporte e serviços. Palestrante em diversos eventos de e-commerce, sempre abordando os assuntos importantes do mundo digital como experiência do cliente, gestão de crises nas redes sociais, estratégias de marketing digital e campanhas on-line."
		profMiniCV += "<br><a href='/Fabio-Marao' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fábio Pereira"){
		...
		profMiniCV += "<br><a href='/Fabio-Pereira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fabio Veneroni"){
		var profMiniCV = "Formado em Administração de Empresas e MBA em Tecnologia da Informação pela USP, trabalhou na área de marketing, merchandising e trade marketing de empresas globais de telecom, healthcare e desenvolvimento de software, como MetLife China, Índia, Johnson & Johnson e Nortel. Especialista em marketing digital e comércio eletrônico, tem participado e coordenado da criação de lojas virtuais, campanhas de geração de tráfego e performance de mais de 200 clientes nos últimos 8 anos."
		profMiniCV += "<br><a href='/Fabio-Veneroni' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fabrizzio Topper"){
		var profMiniCV = "Especialista em planejamento estratégico, com 20 anos de atuação no mercado de consultoria e estratégia empresarial, foi sócio-fundador da agência Naturezzahumana e do Grupo ZZH. Ocupou em sua carreira, diversas posições executivas em empresas nacionais e internacionais e também idealizou multiplos projetos para diversas marcas de renome como: Claro, Telefônica, Microsoft, Apple, Cisco, Promon, Serasa Experian, Natura, Jequiti, Ellus, Shoestock, JBS, HBO entre muitas outras. Já empreendeu 15 projetos empresariais próprios bem sucedidos, entre os quais ainda participa do conselho de gestão de quatro. Graduado em Design de Produtos (FAAP), pós graduado em ADM Financeira (São Francisco), especializou-se em neuromarketing (ESPM), tornou-se mestre em programação neurolinguística (SBPNL) e Master Coach (ICI), cursou MBA de marketing (FGV) e MBA de empreendedorismo (Babson College). Atuou como professor de Pesquisa de Mercado e Gestão de Marcas, na Universidade Anhembi Morumbi, e ainda hoje ministra branding, neuromarketing e planejamento estratégico, na ComSchool. Atualmente é fundador e CEO da TOPPERMINDS, consultoria premiada de planejamento e arquitetura de negócios digitais."
		profMiniCV += "<br><a href='/Fabrizzio-Topper' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Felipe Moimaz"){
		...
		profMiniCV += "<br><a href='/Felipe-Moimaz' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Felipe Orlando Marti"){
		...
		profMiniCV += "<br><a href='/Felipe-Marti' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Felippi Perez"){
		var profMiniCV = "Felippi Perez é Diretor Projetos e Negócios na Keepers Logística atendendo clientes de diversos portes com soluções de armazenagem, manuseio e logística, incluindo empresas de e-commerce. Foi Gerente Administrativo no Grupo Luft. Autor do Livro: Vantagens Competitivas no E-commerce através da Logística. Editora Lexia. Mestrado em Administração de Pequenas e Médias Empresas, Pós graduação em Metodologia e Didática para o Ensino Superior e Graduado em Administração. Professor das disciplinas: Planejamento Estratégico em Logística, Transportes, PCP, Cadeia de Suprimentos e Distribuição, Log Reversa, Operações em Terminais e Armazéns."
		profMiniCV += "<br><a href='/Felippi-Perez' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Felix Grivot"){
		...
		profMiniCV += "<br><a href='/Felix-Grivot' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fernanda Bittencourt"){
		...
		profMiniCV += "<br><a href='/Fernanda-Bittencourt' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Fernanda Nascimento"){
		var profMiniCV = "Fernanda Nascimento é profissional com mais de 22 anos de experiência em planejamento estratégico, especialista em marketing digital e social selling, com passagem por grandes multinacionais como o grupo americano Danaher e a alemã Volkswagen. Business Advisor na FGV e sócia da Stratlab Inteligência Digital, ajuda seus clientes a encontrar consumidores reais no mundo digital."
		profMiniCV += "<br><a href='/Fernanda-Nascimento' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Filipe Bonfim"){
		...
		profMiniCV += "<br><a href='/Filipe-Bonfim' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Flavio Evangelho"){
		var profMiniCV = "Profissional de Marketing Digital com mais de 15 anos de experiência no mercado trabalhando em empresas, como Match.com, Agência Cubo (Coca-Cola) e Zoom. Experiência em compra de mídia em campanhas online, otimização de mídias orgânicas (SEO, EMAIL) em desktop e mobile. Apaixonado por tecnologia e webanalytics."
		profMiniCV += "<br><a href='/Flavio-Evangelho' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Franklin Bravos"){
		...
		profMiniCV += "<br><a href='/Franklin-Bravos' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gabriel Lima"){
		...
		profMiniCV += "<br><a href='/Gabriel-Lima' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gabriel Mattos"){
		var profMiniCV = "No mundo digital desde 2010, planejando projetos e campanhas para sites como Zoom e Zura, além de clientes como Petrobras, Vivo, Oi, O Globo, GM, Prezunic, AD Lifestyle, Toque em Campainha, La Bicyclette, Intel e Festival #Eutonanuvem.Professor do MBA de Marketing Digital no Instituto Infnet e UniCarioca (Rio de Janeiro), dos cursos de extensão da ESPM e palestrante (PUC-RJ, BitWeek, Festival Path, Social Media Week, Inovativa, Cefet Jr).Foi fundador e Social Media Manager na Agência 4tuna. Atualmente é CEO na Na Praça Conteúdo e Performance."
		profMiniCV += "<br><a href='/Gabriel-Mattos' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gabriel Nunes"){
		...
		profMiniCV += "<br><a href='/Gabriel-Nunes' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gabriel Villa"){
		...
		profMiniCV += "<br><a href='/Gabriel-Villa' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "German Quiroga"){
		...
		profMiniCV += "<br><a href='/German-Quiroga' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gilberto Dimenstein"){
		...
		profMiniCV += "<br><a href='/Gilberto-Dimenstein' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gonzalo Greco"){
		var profMiniCV = "Marketing-oriented Industrial Engineer com mais de 8 anos de experiência em vendas e marketing na indústria de bens de consumo. Atualmente trabalhando como líder de eCommerce para o mercado brasileiro. Experiências anteriores em marketing local e regional e atribuições de vendas para a LATAM. Co-fundador da GeoFans, uma ONG que desenvolve plataformas para gerar hábitos sustentáveis."
		profMiniCV += "<br><a href='/Gonzalo-Greco' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gustavo Daher"){
		...
		profMiniCV += "<br><a href='/Gustavo-Daher' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gustavo Erlichman"){
		var profMiniCV = "Gustavo Erlichman é Consultor de E-commerce e Projetos Digitais na GUS.digital e tem passagem por empresas como a Salon Line onde atuou como Gerente de E-commerce e Marketing Digitale. Foi Gerente de Parcerias na Embratel Cloud, Gerente de E-commerce na Multilaser, Gerente de Parcerias na Educaedu.com e Coordenador de Marketing na Locaweb. Também atuou por mais de 10 anos no mercado financeiro como gerente de Home Broker."
		profMiniCV += "<br><a href='/Gustavo-Erlichman' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Gustavo Santos"){
		...
		profMiniCV += "<br><a href='/Gustavo-Santos' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Helio Tadeu Brogna Coelho"){
		...
		profMiniCV += "<br><a href='/Helio-Coelho' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Henrique Almeida"){
		...
		profMiniCV += "<br><a href='/Henrique-Almeida' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Hugo Yang"){
		var profMiniCV = "Hugo é um dos maiores especialistas no cenário de desenvolvimento de negócios e inovações de apps no Brasil. É CEO na Fábrica de Aplicativos, uma plataforma intuitiva, que ajuda qualquer pessoa sem conhecimentos técnicos a criar um aplicativo mobile. Hugo foi sócio na Mauá Capital, gestora de recursos independente, onde era responsável pela alocação de ativos offshore na carteira e pelas análises econômicas das principais economias mundiais."
		profMiniCV += "<br><a href='/Hugo-Yang' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Ivan Alves"){
		...
		profMiniCV += "<br><a href='/Ivan-Alves' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Jacob André Gomes"){
		...
		profMiniCV += "<br><a href='/Jacob-Gomes' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Jannos Artusi"){
		var profMiniCV = "Profissional com mais de 16 anos de experiência em marketing, sendo 6 deles focado em e-commerce. Já passou por empresas como Claro, Vivo, BlackBerry e Microsoft. Hoje é head do canal de e-commerce da Samsung para as categorias de Smartphone e tablets."
		profMiniCV += "<br><a href='/Jannos-Artusi' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Jason Baroni"){
		...
		profMiniCV += "<br><a href='/Jason-Baroni' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "João Ramirez"){
		...
		profMiniCV += "<br><a href='/Joao-Ramirez' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "José Batista de Queiroz Filho"){
		...
		profMiniCV += "<br><a href='/Jose-Filho' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "José Paulo Motta"){
		...
		profMiniCV += "<br><a href='/Jose-Motta' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Juliana Lorenzetti"){
		...
		profMiniCV += "<br><a href='/Juliana-Lorenzetti' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Katia Nuno"){
		...
		profMiniCV += "<br><a href='/Katia-Nuno' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Kleber Forato"){
		...
		profMiniCV += "<br><a href='/Kleber-Forato' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Leandro Soares"){
		...
		profMiniCV += "<br><a href='/Leandro-Soares' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Leonardo Franco"){
		...
		profMiniCV += "<br><a href='/Leonardo-Franco' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Leonardo Godoi"){
		...
		profMiniCV += "<br><a href='/Leonardo-Godoi' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Leonardo Palagi"){
		...
		profMiniCV += "<br><a href='/Leonardo-Palagi' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Leonardo Pallotta"){
		...
		profMiniCV += "<br><a href='/Leonardo-Pallotta' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Leonardo Rocha"){
		...
		profMiniCV += "<br><a href='/Leonardo-Rocha' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Leonardo Rodrigues"){
		var profMiniCV = "Coordenador de Mídias Digitais do Grupo Osklen/Om.art, responsável por projetos como E-commerce, midias sociais e sites institucionais. Formado em Design e Webdesign, com extensão em Design Estratégico. Liderou projetos para clientes como Oi, Banco do Brasil, TvZero, Petrobras, Fundação Bienal de SP, Coca-Cola, Secretaria de Cultura do Estado do RJ, entre outros. Teve projetos selecionados para a Bienal de Design da ADG. Recebeu 3 prêmios Peixe Grande e um Webby Award na categoria NetArt. Gerencia equipes digitais há mais de 10 anos, passando pela Selulloid AG, Tecnopop e Conspiração Filmes."
		profMiniCV += "<br><a href='/Leonardo-Rodrigues' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Letícia Ito"){
		...
		profMiniCV += "<br><a href='/Leticia-Ito' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Levi Lopes"){
		...
		profMiniCV += "<br><a href='/Levi-Lopes' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Lilian Gonçalves"){
		...
		profMiniCV += "<br><a href='/Lilian-Goncalves' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Liliane Ferrari"){
		...
		profMiniCV += "<br><a href='/Liliane-Ferrari' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Lisandra Maioli"){
		...
		profMiniCV += "<br><a href='/Lisandra-Maioli' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Lucas Torres"){
		...
		profMiniCV += "<br><a href='/Lucas-Torres' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Luís Felipe Cota"){
		...
		profMiniCV += "<br><a href='/Luis-Cota' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Luiz Dias"){
		...
		profMiniCV += "<br><a href='/Luiz-Dias' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Luiz Vergueiro"){
		...
		profMiniCV += "<br><a href='/Luiz-Vergueiro' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Marcel Albuquerque"){
		...
		profMiniCV += "<br><a href='/Marcel-Albuquerque' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Marcelo Colombari"){
		...
		profMiniCV += "<br><a href='/Marcelo-Colombari' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Marcelo Vieira"){
		var profMiniCV = "Foi Gerente Geral de Operações na B2W Digital (Americanas, Submarino e Shoptime) e Gerente Regional de Operações na TCI BPO. Atualmente é Gerente de Intralogística na BR Supply. Tem mais 13 anos de experiência na área de operações. Atua no Planejamento estratégico de médio e longo prazo, com constante monitoramento para redução de custos e otimização das rotinas de trabalho apoiado na utilização das ferramentas de gestão. Experiência no sistema de gestão corporativo e controles orçamentário (DRE e P&L). Sólidos conhecimentos e vivencia diária no chão de fabrica e suas rotinas, LEAN MANUFACTORING, documentação e registros dos itens de produção, padrões ISO, QS."
		profMiniCV += "<br><a href='/Marcelo-Vieira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Marcio Chaer"){
		...
		profMiniCV += "<br><a href='/Marcio-Chaer' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Marcos Juncken"){
		...
		profMiniCV += "<br><a href='/Marcos-Juncken' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Mário Guimarães"){
		...
		profMiniCV += "<br><a href='/Mario-Guimaraes' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Maudy Pedrão"){
		...
		profMiniCV += "<br><a href='/Maudy-Pedrao' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Mauricio Cardoso"){
		...
		profMiniCV += "<br><a href='/Mauricio-Cardoso' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Mauricio Salvador"){
		...
		profMiniCV += "<br><a href='/Mauricio-Salvador' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Nilson Toledo"){
		...
		profMiniCV += "<br><a href='/Nilson-Toledo' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Núbia Mota"){
		...
		profMiniCV += "<br><a href='/Nubia-Mota' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Pablo Moura"){
		...
		profMiniCV += "<br><a href='/Pablo-Moura' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Patricia Amaro"){
		var profMiniCV = "Patricia possui mais de 15 anos executando estratégias de marketing e digital em muitos setores, como varejo, publicidade, comércio eletrônico e bens de consumo. Como chefe de comércio eletrônico na Unilever, implementou, desenvolveu e executou estratégias e atividades de canal incluindo 3-5 anos de planejamento estratégico, team building e desenvolvimento de clientes."
		profMiniCV += "<br><a href='/Patricia-Amaro' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Patricia Knipl"){
		...
		profMiniCV += "<br><a href='/Patricia-Knipl' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Paulo Dornelas"){
		...
		profMiniCV += "<br><a href='/Paulo-Dornelas' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Paulo Moreira"){
		...
		profMiniCV += "<br><a href='/Paulo-Moreira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Paulo Oliveira Neto"){
		var profMiniCV = "Formado em Marketing pela ESPM e com MBA em Gerenciamento de Projetos pela FGV, possui mais de 15 anos de experiência nas áreas de marketing e e-commerce. Hoje é o responsável pela área de Digital da Kärcher Brasil, tendo passado por empresas como Philips, Microsoft, IBM, Döhler e Elsys. Atuou também como consultor para implementação de canais online além de projetos voltados para social media, SEO, SEM, e-mail marketing, integração de sistemas etc., atendendo clientes como Laris, Cantaloop, SavoiCom, Lutz Automotive, Grupo Edenred e outros."
		profMiniCV += "<br><a href='/Paulo-Neto' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Paulo Salvador"){
		...
		profMiniCV += "<br><a href='/Paulo-Salvador' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Pedro Scripilliti"){
		var profMiniCV = "Graduado em Desenho Industrial pela Faculdade da Cidade ingressou no E-commerce em 2006 como Gestor da Ifranquia, empresa do grupo DotCom (antiga Sacks) que prestava consultoria e gestão de e-commerces. Teve passagens por empresas como E-Plataforma, E-hub, Primordia, Vtex e B2W sempre atuando diretamente com clientes e parceiros na montagem e desenvolvimento de operações online. Presta algumas consultorias pontuais e atualmente é Head de E-commerce da Vizcaya Cosméticos."
		profMiniCV += "<br><a href='/Pedro-Scripilliti' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Perla Amabile"){
		...
		profMiniCV += "<br><a href='/Perla-Amabile' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rafael Biselli"){
		var profMiniCV = "Administrador pela EAESP- FGV, com especialização na Bocconi (Milão) e FGV. Experiência de 18 anos em bens de consumo com passagens por Marketing, Planejamento Estratégico, Trade Marketing e Vendas. Atualmente lidera o e-Commerce na Nestlé."
		profMiniCV += "<br><a href='/Rafael-Biselli' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rafael Brito"){
		...
		profMiniCV += "<br><a href='/Rafael-Brito' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rafael Sesto"){
		var profMiniCV = "Mestre em Logística pela PUC-Rio, Diretor da ARM Logística, Professor de MBA da Universidade Federal Fluminense, da Unigranrio e de Graduação em Logística no SENAC, está a 18 anos na área de logística de Comércio B2B e B2C. Com atuação destacada em empresas de grande porte como Shell, White Martins e AmBev, dentro e fora do Brasil."
		profMiniCV += "<br><a href='/Rafael-Sesto' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Raphael Penna"){
		...
		profMiniCV += "<br><a href='/Raphael-Penna' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Regina Monge"){
		...
		profMiniCV += "<br><a href='/Regina-Monge' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Renato Chaves"){
		...
		profMiniCV += "<br><a href='/Renato-Chaves' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Renato Mendes"){
		...
		profMiniCV += "<br><a href='/Renato-Mendes' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Ricardo Nery"){
		var profMiniCV = "Especialista em Mídia Display, Comportamento do Consumidor e Programa de Afiliados, tem formação em Sistemas Online pelo Grupo IBMEC. Trabalhou nas operações do MSN e formou a primeira equipe no Brasil de Doubleclick na DQ&A (Empresa especializada em Adserver) atendendo clintes de Branding e Varejo. Está na Netshoes desde 2011 gerenciando todas as campanhas de Retargeting e Afiliados. Trabalhou junto com a equipe de TI na implementação de todas as novas tecnologias da empresa para melhorar as performances das campanhas do Marketing Online. Colunista no iMaster há 6 anos, escreveu artigos sobre a Privacidade online e o avanço da Internet no mundo."
		profMiniCV += "<br><a href='/Ricardo-Nery' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Roberto Motta"){
		...
		profMiniCV += "<br><a href='/Roberto-Motta' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodolfo Oliveira"){
		var profMiniCV = "Contador de histórias, publicitário, pesquisador, jedi, escritor e ilustrador. Em 13 anos de experiência transitou em diversas áreas de comunicação. Foi responsável pelo Trade Marketing da Accor Hotels, atuou em grandes eventos internacionais como o Rock in Rio e Red Bull Air Race , trabalhou em projetos com algumas das maiores empresas do Brasil e é sócio na agência Corazonada Brand Storytelling e Project Leader na Agência Tudo."
		profMiniCV += "<br><a href='/Rodolfo-Oliveira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodrigo Bandeira"){
		...
		profMiniCV += "<br><a href='/Rodrigo-Bandeira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodrigo Esch"){
		...
		profMiniCV += "<br><a href='/Rodrigo-Esch' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodrigo Gadelha"){
		...
		profMiniCV += "<br><a href='/Rodrigo-Gadelha' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodrigo Galvão"){
		var profMiniCV = "Sócio da P3 Participações; Consultor de Inovação do SEBRAE e Professor de Marketing e Estratégias digitais no MBA de Gestão de Serviços da Universidade Federal Fluminense e em cursos de extensão como LAJE e Polo Criativo. Pós-graduado pelo MBA em Marketing Estratégico da ESPM e Bacharel em Turismo (UFF). Atua há mais de 5 anos na área de Marketing com ênfase em planejamento digital, tendo trabalhado com grandes empresas como Airbnb, Booking.com, Globosat, Grupo Technos e FIRJAN."
		profMiniCV += "<br><a href='/Rodrigo-Galvao' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodrigo Gonçalves"){
		...
		profMiniCV += "<br><a href='/Rodrigo-Goncalves' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodrigo Mourão"){
		var profMiniCV = "Cofundador e diretor de tecnologia da Webjump, empresa Silver Solution Partner Magento. Com mais de 15 anos de experiência em e-commerce e 4 anos em Magento, é responsável pela equipe de desenvolvedores e implantação, integração e customização da plataforma. Dentre suas certificações estão Magento Front End Developer, Magento Developer Plus, Fundamentals of Magento Development (Sede Magento / Los Angeles), Checkout Payments e Requirements Discovery For Successful Magento Implementations."
		profMiniCV += "<br><a href='/Rodrigo-Mourao' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rodrigo Rio"){
		...
		profMiniCV += "<br><a href='/Rodrigo-Rio' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Ronald Filho"){
		var profMiniCV = "Atuei durante 4 anos como coordenado de estúdio da empresa Centauro (maior distribuidora de produtos esportivos da América Latina), desenvolvendo atividade atreladas ao e-Commerce e editoriais,organograma e fluxograma estúdio, composto por três áreas diferentes, fotografia, tratamento de imagem e conteúdo técnico.Estudo de leitura de imagem, quando agregada ao ambiente e-commerce, construtor de padrões para visualizações no canal web, direção fotográfica e fotografia com modelo para editoriais.Entre minhas características básicas encontram-se: adaptabilidade, bom humor, responsabilidade, inteligencia emocional e bom relacionamento em geral.Sou graduado em Criação e Produção Gráfica, com Pós graduação em Criação Visual e Multimídia. Informo ainda que estou disponível para viagens, de acordo com a necessidade da organização."
		profMiniCV += "<br><a href='/Ronald-Filho' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Rubem Razões"){
		...
		profMiniCV += "<br><a href='/Rubem-Razões' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Samuel Gonsales"){
		...
		profMiniCV += "<br><a href='/Samuel-Gonsales' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Sara Zimmermann"){
		...
		profMiniCV += "<br><a href='/Sara-Zimmermann' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Stefan Rehm"){
		...
		profMiniCV += "<br><a href='/Stefan-Rehm' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Stephanie Santos "){
		...
		profMiniCV += "<br><a href='/Stephanie-Santos' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Thalita Bottari"){
		...
		profMiniCV += "<br><a href='/Thalita-Bottari' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Thiago Cazzaro"){
		...
		profMiniCV += "<br><a href='/Thiago-Cazzaro' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Thiago Ferrari"){
		var profMiniCV = "Gerente de E-commerce na Reserva onde atua com Gestão comercial e operacional dos canais virtuais (E-commerce / F-commerce), criou o canal e-commerce e os todos processos internos para a operação (Front e Back), faz interface com áreas de marketing, redes sociais, financeiro, contábil, fiscal e TI. Atua no planejamento de marketing online, controle orçamentário e novos negócios digitais e no desenvolvimento de pessoas. Formado em Administração de Marketing na Escola Superior de Propaganda e Marketing. MBA na Fundação Getulio Vargas / FGV. Foi Analista Senior de Web Analytics na Ágora Corretora. Coordenador de E-commerce na Klavins LTDA (Holding do Grupo Redley e Cantão)."
		profMiniCV += "<br><a href='/Thiago-Ferrari' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Thiago José Loch"){
		...
		profMiniCV += "<br><a href='/Thiago-Loch' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Thiago Pereira"){
		...
		profMiniCV += "<br><a href='/Thiago-Pereira' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Thiago Veras"){
		...
		profMiniCV += "<br><a href='/Thiago-Veras' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Thiely Medeiros"){
		...
		profMiniCV += "<br><a href='/Thiely-Medeiros' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Tiago Batitucci"){
		var profMiniCV = "Tiago é Publicitário com especializações em Markting e ADM: experiência de 10 anos atuando no mercado digital em empresas e indústrias de médio e grande porte, onde foi responsável pela transformação digital em diferentes mercados: Alimentar, Cosméticos e Perfumaria, Eletrônicos e bens de consumo."
		profMiniCV += "<br><a href='/Tiago-Batitucci' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Tiago Otani"){
		...
		profMiniCV += "<br><a href='/Tiago-Otani' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Tiago Rocha"){
		var profMiniCV = "Especialista em SEO e Web Analytics. Implantando SEO nos maiores e-commerce, portais e empresas brasileiras desde 2010, hoje atuo fortemente em internacionalização de startups brasileiras para o mercado LATAM. Além de desenvolver um trabalho de consultor SEO, trabalho na Involves onde encabeço todos os projetos de SEO da empresa."
		profMiniCV += "<br><a href='/Tiago-Rocha' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Vinicius Canola"){
		...
		profMiniCV += "<br><a href='/Vinicius-Canola' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Vinicius Mancini"){
		...
		profMiniCV += "<br><a href='/Vinicius-Mancini' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Wallan Machado"){
		...
		profMiniCV += "<br><a href='/Wallan-Machado' target='_blank'>Ver mais detalhes</a>"
	}
    ...
    if(profName == "Will Trannin"){
		...
		profMiniCV += "<br><a href='/Will-Trannin' target='_blank'>Ver mais detalhes</a>"
	}
